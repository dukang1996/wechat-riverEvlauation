Page({
  ...
  judgeC4: function (e) {
    var nowC4 = e.detail.value
    var beforC4 = this.data.beforC4
    var valueC4 = (beforC4 - nowC4) * 100 / beforC4
    var id = this.data.typeId
    var scoreC4 = 0
  ...
  judgeC11: function (e) {
    var id = this.data.typeId
    var lengthC11 = e.detail.value
    var scoreC11 = 0
    var riverLength = this.data.riverLength
    var valueC11 = lengthC11 * 100 / riverLength
  ...
  judgeC12: function (e) {
    var id = this.data.typeId
    var LC12 = e.detail.value
    var scoreC12 = 0
    var riverL = this.data.riverL
    var valueC12 = LC12 * 100 / riverL
